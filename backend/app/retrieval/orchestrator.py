"""Answer orchestration: the Excel workflow lane, agent run execution, and legacy answer path."""
...
from .persistence import insert_artifacts, insert_citations, insert_message
...
def _retrieval_facade():
    """Resolve the retrieval package so monkeypatched facade attributes apply."""
...
async def execute_agent_run(run_id: str) -> str | None:
    ...
    try:
        ...
        provider = await _retrieval_facade().ensure_provider_ready()
